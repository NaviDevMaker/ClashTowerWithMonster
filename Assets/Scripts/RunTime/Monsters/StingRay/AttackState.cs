...
{
    public class AttackState : AttackStateBase<StingRayController>
    {
        ...
        public override void OnEnter()
        {
            ...
            if (attackEndNomTime == 0f) StateFieldSetter.AttackStateFieldSet<StingRayController >(controller, this, clipLength,10,

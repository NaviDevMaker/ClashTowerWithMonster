...
public class HandController
{
    ...
    Func<List<Card>, UniTask> DealCardAction;
    ...
    public HandController(List<Card> myDeck,UnityAction<List<Card>, Card> action,UnityAction<Card> action1
        ,UnityAction<Card,int> action2,UnityAction<Card,List<Card>> action3, Func<List<Card>,UniTask> action4)
    {
        SetFirstHandOnUI = action;
        NextCardSetOnUI = action1;
        OnUsedCard = action2;
        OnChangedNextCard = action3;
        DealCardAction = action4;
    ...
    async void Initialize()
    {
        ...
        await DealCardAction(firstHand);
